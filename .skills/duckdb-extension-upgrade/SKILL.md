...
description: Upgrade the observefs extension to a new DuckDB release. Use when the user asks to upgrade DuckDB, bump the duckdb submodule, sync to a new DuckDB tag (e.g. v1.5.2), or update the duckdb / duckdb-httpfs / extension-ci-tools submodules together.
---

# Upgrade observefs to a new DuckDB release
